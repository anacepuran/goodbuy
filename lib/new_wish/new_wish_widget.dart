...
import 'new_wish_model.dart';
export 'new_wish_model.dart';

class NewWishWidget extends StatefulWidget {
  const NewWishWidget({super.key});

  static String routeName = 'NewWish';
  static String routePath = '/newWish';

  @override
  State<NewWishWidget> createState() => _NewWishWidgetState();
}

class _NewWishWidgetState extends State<NewWishWidget> {
  late NewWishModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewWishModel());
    ...
    _model.reasonFocusNode!.addListener(() => safeSetState(() {}));
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '\"Do I really need this?\" timer - we will check in with you after this time period ends.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await WishesRecord.collection
                            .doc()
                            .set(createWishesRecordData(
                              name: _model.itemNameTextController.text,
                              reason: _model.reasonTextController.text,
