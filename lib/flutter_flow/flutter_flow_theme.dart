...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFCBDED3);
  late Color secondary = const Color(0xFF8BA49A);
  late Color tertiary = const Color(0xFFD2C49E);
  late Color alternate = const Color(0xFF3B6255);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF4B4B4B);
  late Color primaryBackground = const Color(0xFFE2DFDA);
